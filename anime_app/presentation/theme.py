"""Дизайн-система ПК-версии: цвета, радиусы, отступы и стили всех общих элементов (Qt Style Sheets).

Те же токены — в мобильной версии (mobile/www/css/tokens.css). Новые элементы берут цвета и радиусы отсюда,
а не задают свои в setStyleSheet.
"""
# Цвета
ACCENT = "#ff6a1a"
ACCENT_HOVER = "#ff8340"
...
STAR = "#ffc83d"
# Радиусы и отступы
RADIUS_S, RADIUS_M, RADIUS_L = 6, 10, 14
SPACE_PAGE_X, SPACE_PAGE_Y = 32, 28
...
QPushButton#DubButton {{ padding-right: 34px; }}
...
QLabel#Badge, QLabel#BadgeGreen, QLabel#BadgeRed {{
    background: {ACCENT}; color: white; border-radius: {RADIUS_S}px; padding: 2px 7px;
    font-size: 11px; font-weight: 700;
}}
QLabel#BadgeGreen {{ background: {SUCCESS_BG}; }}
QLabel#BadgeRed {{ background: {DANGER_BG}; padding: 4px 6px; }}
QLabel#Poster {{ background: {SURFACE_2}; border-radius: {RADIUS_M}px; }}
QLabel#SeasonCurrent {{ font-weight: 600; font-size: 13px; color: {ACCENT}; }}
QLabel#Description {{ color: #d0d0d8; }}
QLabel#AiText {{ color: #e6e6ec; font-size: 15px; }}
