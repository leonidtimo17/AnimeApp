...
class LibraryPage(Page):
    def __init__(self, ctx):
        ...
        backup.setMenu(menu)
        self.shiki_btn = QPushButton()
        self.shiki_btn.setIcon(icon("link", TEXT, 15))
        self.shiki_menu = QMenu(self.shiki_btn)
        self.shiki_menu.aboutToShow.connect(self._fill_shiki_menu)
        self.shiki_btn.setMenu(self.shiki_menu)
        head.addWidget(self.shiki_btn)
